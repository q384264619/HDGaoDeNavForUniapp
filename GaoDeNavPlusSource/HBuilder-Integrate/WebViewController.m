...
- (void)viewDidLoad
{
    ...
    if (pCoreHandle != nil)
    {
        ...
        NSString* pFilePath = [NSString stringWithFormat:@"file://%@/%@", [NSBundle mainBundle].bundlePath, @"Pandora/apps/__UNI__GaoDeNav/www/plugin.html"];
        [pCoreHandle start];
        ...
        appFrame = [[PDRCoreAppFrame alloc] initWithName:@"__UNI__GaoDeNav" loadURL:pFilePath frame:StRect];
        if (appFrame) {
