...
- (void)loadView
{
   ...
   NSString* pWWWPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"Pandora/apps/__UNI__GaoDeNav/www"];
  ...
  //  pAppHandle = [[[PDRCore Instance] appManager] openAppWithAppid:@"__UNI__GaoDeNav" withArgs:pArgus withDelegate:nil];
